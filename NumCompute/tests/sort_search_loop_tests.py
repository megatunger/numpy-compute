...
class StableSortTests(unittest.TestCase):
    ...
    def test_basic(self):
        a = np.array([3, 1, 2])
        self.assertTrue(np.array_equal(stable_sort_loop(a), np.array([1, 2, 3])))

    def test_sort_looped(self):
        a = np.array([1, 2, 3])
        self.assertTrue(np.array_equal(stable_sort_loop(a), a))

    def test_reverse_sort_looped(self):
        a = np.array([3, 2, 1])
        self.assertTrue(np.array_equal(stable_sort_loop(a), np.array([1, 2, 3])))

    def test_repeats(self):
        a = np.array([3, 1, 2, 1])
        self.assertTrue(np.array_equal(stable_sort_loop(a), np.array([1, 1, 2, 3])))
    ...
    def test_shape(self):
        a = np.random.rand(3)
        self.assertEqual(stable_sort_loop(a).shape, a.shape)
...
class MultiKeySortTests(unittest.TestCase):
    def test_single_column(self):
        ...
        expected = np.array([[1, 2],
                             [2, 3],
                             [3, 1]])
        self.assertTrue(np.array_equal(multi_key_sort_loop(a, [0]), expected))
    ...
    def test_two_columns(self):
        ...
        expected = np.array([[1, 1],
                             ...
                             [2, 1],
                             [2, 2]])
        # sort_looping column 0 first, then 1
        self.assertTrue(np.array_equal(multi_key_sort_loop(a, [0, 1]), expected))
    ...
    def test_two_columns_reversed(self):
        ...
        expected = np.array([[1, 1],
                             ...
                             [2, 2],
                             [1, 3]])
        # sort_looping column 1 first, then 0
        self.assertTrue(np.array_equal(multi_key_sort_loop(a, [1, 0]), expected))
    ...
    def test_equal_primary_key(self):
        ...
        expected = np.array([[1, 1],
                             [1, 2],
                             [1, 3]])
        np.testing.assert_array_equal(multi_key_sort_loop(a, [0, 1]), expected)
...
class BinarySearchTests(unittest.TestCase):
    def test_exist(self):
        ...
        index, exist = binary_search_loop(a, 3)
        self.assertEqual(index, 2)
        self.assertTrue(exist)

    def test_not_exist(self):
        a = np.array([1, 2, 3, 4, 5])
        index, exist = binary_search_loop(a, 6)
        self.assertEqual(index, len(a))
        self.assertTrue(not exist)

    def test_first(self):
        a = np.array([1, 2, 3, 4, 5])
        index, exist = binary_search_loop(a, 1)
    ...
    def test_repeats(self):
        ...
        index, exist = binary_search_loop(a, 2)
    ...
    def test_floats(self):
        ...
        index, exist = binary_search_loop(a, 4.4)
...
class QuickSelectTests(unittest.TestCase):
    ...
    def test_basic(self):
        a = np.array([3, 1, 4, 1, 5])
        self.assertEqual(quickselect_loop(a, 2), 3)

    def test_smallest(self):
        a = np.array([3, 1, 4, 1, 5, 9, 2, 6])
        self.assertEqual(quickselect_loop(a, 0), 1)

    def test_largest(self):
        a = np.array([3, 1, 4, 1, 5, 9, 2, 6])
        self.assertEqual(quickselect_loop(a, len(a) - 1), 9)
    ...
    def test_repeats(self):
        ...
        self.assertEqual(quickselect_loop(a, 2), 1)
